...
const cookies = () => {
  return (
    <Layout
      ...
      subtitle="The Cookies Policy of The Grande Gatsby"
    >
      <section className="privacy">
        <h1>Cookie Policy for The Grande Gatsby</h1>

        <p>
          This is the Cookie Policy for The Grande Gatsby, accessible from
          https://thegrandegatsby.netlify.app/
        </p>
